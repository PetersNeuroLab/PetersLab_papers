%% Generate figures for Marica et al 2025
%
...
%% [Fig 1B-C, Supp. Fig 1B] Reaction mean/index, learning day histogram
...
%% [Fig 2A,D] Task cortex + striatum trial heatmap
...
%% [Fig 2C,F] Task cortex + striatum max, split within session
...
%% [Supp. Fig 1A] Example wheel velocity
...
%% [Supp. Fig 3] Striatal domain clustering and classification
