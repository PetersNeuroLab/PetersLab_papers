...
for curr_groups=1:2
    ...
    exportgraphics(gcf, fullfile(plab.locations.server_path,...
        ['Lab\Papers\Song_2026\submission_3_NatureCommunications\revisions\revision_figures\eps\Fig_s5_' num2str(curr_groups) '.eps']), ...
        'ContentType','vector');
end
...
exportgraphics(gcf, fullfile(plab.locations.server_path,...
    'Lab\Papers\Song_2026\submission_3_NatureCommunications\revisions\revision_figures\eps\Fig_s5_3.eps'), ...
    'ContentType','vector');
