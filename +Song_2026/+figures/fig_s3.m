...
exportgraphics(gcf, fullfile(plab.locations.server_path,...
    'Lab\Papers\Song_2026\submission_3_NatureCommunications\revisions\revision_figures\eps\Fig_s3_A1.eps'), ...
    'ContentType','vector');
...
exportgraphics(gcf, fullfile(plab.locations.server_path,...
    'Lab\Papers\Song_2026\submission_3_NatureCommunications\revisions\revision_figures\eps\Fig_s3_A2.eps'), ...
    'ContentType','vector');
